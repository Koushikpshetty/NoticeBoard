<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="DNB.AdminLogin" %>
<!DOCTYPE html>
<html lang="en" data-theme="dark">
<head runat="server">
<meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/>
<title>Admin Login — Digital Notice Board</title>
...
<div class="auth-wrap">
 <div class="auth-card">
 <div class="auth-head auth-head-admin">
 <div class="auth-icon auth-icon-admin"><i class="fas fa-shield-halved"></i></div>
 <h2 class="auth-title">Admin Login</h2>
 <p class="auth-sub">Sign in to manage the notice board</p>
 </div>
 <div class="auth-body">
 ...
 <asp:TextBox ID="txtUser" runat="server" CssClass="form-inp" placeholder="Enter admin username" MaxLength="50"/>
 </div>
 ...
 <asp:TextBox ID="txtPwd" runat="server" CssClass="form-inp" TextMode="Password" placeholder="Enter password" MaxLength="100"/>
 </div>
 ...
 <asp:Button ID="btnLogin" runat="server" Text="Sign In as Admin" CssClass="btn-submit btn-red w-100 mb-4" OnClick="btnLogin_Click"/>
 ...
 <a href="StudentLogin.aspx" class="link-teal">Student Login</a>
 </div>
 </div>
 </div>
</div>
